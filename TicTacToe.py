    ...
    while game.empty_squares():
        if letter == '0':
            ...
            while square not in game.available_moves():
                square = input('\033[95mEnter your move (1-9): \033[0m')
                try:
                    square = int(square) - 1
            ...
            print(f'\033[95m{player_name} moved to square {square + 1}\033[0m')
            game.print_board()
            ...
            game.make_move(square, letter)
            print(f'\033[95mAI moved to square {square + 1}\033[0m')
            game.print_board()
